  ...
  <div class="grid grid-cols-12 gap-4 p-4 w-full h-full">
    <div class="flex flex-col gap-3 col-span-3">
      <form @submit.prevent="add" class="flex flex-col gap-3">
        ...
        <button
          type="submit"
          class="bg-blue-700 hover:bg-blue-800 cursor-pointer text-sm text-white font-semibold py-1 rounded"
        >
          New
        </button>
      </form>
    ...
    <div
      class="col-start-4 col-span-3 flex flex-col gap-3 max-h-[43rem] font-semibold overflow-auto"
    >
      <div class="flex items-center justify-between">
        <h2 class="text-white font-semibold">Ordem de Iniciativa</h2>
        <button
          @click="clearBattle"
          class="bg-red-600 hover:bg-red-700 cursor-pointer text-white px-3 py-1 rounded-md text-xs transition-colors"
        >
          Limpar Batalha
        </button>
      </div>
    ...
    <div
      class="col-start-10 col-span-3 border-l font-semibold border-neutral-700"
    >
      <div class="ml-2 flex flex-col gap-3">
        ...
        >
          ...
          <button
            class="bg-blue-600 hover:bg-blue-700 transition-all duration-300 cursor-pointer rounded-md px-4 h-6"
          >
            Add
          </button>
        </div>
